...
public class InvoiceModel implements Serializable{
	...
	private int quotId;
	private Set<InvoiceItemModel> quotationItemSet = new HashSet<InvoiceItemModel>();

	public InvoiceModel(int id, ClientModel client, Date date,
	...
	public Set<InvoiceItemModel> getQuotationItemSet() {
		return quotationItemSet;
	}

	public void setQuotationItemSet(Set<InvoiceItemModel> quotationItemSet) {
