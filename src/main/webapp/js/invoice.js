...
function addRow1(){
	 if($("#product").val() == "no"){
		 ...
		 var product,unit,quantity,actPrice,unitPrice,discount,tax,taxp,totAmt,del;
		 var rowcount = getRowsLength();
		  var p = $("#product").val().split("@$");
		  var quotId = "<td style=\"display: none;\">"+p[0]+"</td>"
		  product= "<td>"+p[1]+"</td>";
		  unit = "<td>"+p[2]+"</td>";
		  quantity = "<td id=\"quantity"+rowcount+"\">"+$("#qua").val()+"</td>";
		  actPrice = "<td>"+$("#avUnit").val()+"</td>";
		  unitPrice = "<td id=\"unit"+rowcount+"\">"+$("#unit").val()+"</td>";
		  discount = "<td id=\"discount"+rowcount+"\">"+$("#discount").val()+"</td>";
		  tax = "<td id=\"tax"+rowcount+"\">"+$("#tax").val()+"</td>";
		  taxp = "<td id=\"taxp"+rowcount+"\">"+$("#taxPerc").val()+"</td>";
		  totAmt = "<td id=\"total"+rowcount+"\">"+$("#totalAmt").val()+"</td>";
		  del = "<td><a href=\"#\" onclick=\"deleteRow("+rowcount+","+$("#qua").val()+","+$("#totalAmt").val()+")\">delete</a></td>"
		 var row = "<tr id=\"row"+rowcount+"\">"+quotId+product+unit+quantity+actPrice+unitPrice+discount+tax+taxp+totAmt+del+"</tr>";
		 var totQua = parseInt($("#totalQuantity").val()) + parseInt($("#qua").val());
		 var totAmount = parseInt($("#totAmt").val()) + parseInt($("#totalAmt").val());
		 $("#totalQuantity").val(totQua);
